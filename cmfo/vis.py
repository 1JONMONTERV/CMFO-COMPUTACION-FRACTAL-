...
def plot_tensor_ascii(tensor: np.ndarray, label: str = None):
    """
...
def plot_attractor_trajectory(sequence: list):
    ...
    for vec in sequence:
        ...
        if dom_dim == 0: sys.stdout.write("-")
        elif dom_dim == 1: sys.stdout.write("/")
        elif dom_dim == 2: sys.stdout.write("|")
        elif dom_dim == 3: sys.stdout.write("\\")
        elif dom_dim == 4: sys.stdout.write("_")
        elif dom_dim == 5: sys.stdout.write("^")
        elif dom_dim == 6: sys.stdout.write("*")
    print("< End")
